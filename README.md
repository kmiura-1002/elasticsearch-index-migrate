...
_See code: [src/commands/init.ts](https://github.com/kmiura-1002/elasticsearch-index-migrate/blob/v0.3.2/src/commands/init.ts)_
...
_See code: [src/commands/plan.ts](https://github.com/kmiura-1002/elasticsearch-index-migrate/blob/v0.3.2/src/commands/plan.ts)_
<!-- commandsstop -->
